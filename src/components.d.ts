...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'article-list': LocalJSX.ArticleList &
        JSXBase.HTMLAttributes<HTMLArticleListElement>;
      'article-meta': LocalJSX.ArticleMeta &
        JSXBase.HTMLAttributes<HTMLArticleMetaElement>;
      'article-page': LocalJSX.ArticlePage &
        JSXBase.HTMLAttributes<HTMLArticlePageElement>;
      'auth-page': LocalJSX.AuthPage &
        JSXBase.HTMLAttributes<HTMLAuthPageElement>;
      'comment-form': LocalJSX.CommentForm &
        JSXBase.HTMLAttributes<HTMLCommentFormElement>;
      'editor-page': LocalJSX.EditorPage &
        JSXBase.HTMLAttributes<HTMLEditorPageElement>;
      'error-display': LocalJSX.ErrorDisplay &
        JSXBase.HTMLAttributes<HTMLErrorDisplayElement>;
      'home-page': LocalJSX.HomePage &
        JSXBase.HTMLAttributes<HTMLHomePageElement>;
      'home-tags': LocalJSX.HomeTags &
        JSXBase.HTMLAttributes<HTMLHomeTagsElement>;
      'loading-spinner': LocalJSX.LoadingSpinner &
        JSXBase.HTMLAttributes<HTMLLoadingSpinnerElement>;
      'not-found': LocalJSX.NotFound &
        JSXBase.HTMLAttributes<HTMLNotFoundElement>;
      'profile-page': LocalJSX.ProfilePage &
        JSXBase.HTMLAttributes<HTMLProfilePageElement>;
      'settings-page': LocalJSX.SettingsPage &
        JSXBase.HTMLAttributes<HTMLSettingsPageElement>;
      'single-comment': LocalJSX.SingleComment &
        JSXBase.HTMLAttributes<HTMLSingleCommentElement>;
      'tabbed-feed': LocalJSX.TabbedFeed &
        JSXBase.HTMLAttributes<HTMLTabbedFeedElement>;
    }
  }
}
